...
export function buildOrderConfirmationEmailHtml({
  ...
  orderNumber: string;
  items: SendEmailParams['items'];
  totals: SendEmailParams['totals'];
  shippingAddress: SendEmailParams['shippingAddress'];
