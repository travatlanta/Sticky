...
const statusConfig: Record<string, { icon: any; color: string; bgColor: string; label: string }> = {
  ...
  in_production: { icon: Package, color: "text-blue-600", bgColor: "bg-blue-100", label: "In Production" },
  printed: { icon: Package, color: "text-purple-600", bgColor: "bg-purple-100", label: "Printed" },
  ...
  cancelled: { icon: Clock, color: "text-red-600", bgColor: "bg-red-100", label: "Cancelled" },
};
