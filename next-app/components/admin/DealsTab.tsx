    ...
    <Card className="overflow-hidden max-w-sm">
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {data.quantity && <Badge variant="secondary">{data.quantity} pcs</Badge>}
          {data.productSize && <Badge variant="secondary">{data.productSize}</Badge>}
    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600 text-sm">Manage promotional deal cards</p>
        </div>
