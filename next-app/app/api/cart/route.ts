...
export async function GET(request: Request) {
  try {
    ...
    // Note: cutType column may not exist in production yet - using raw SQL to handle gracefully
    ...
    // Note: cutType modifier temporarily disabled until production DB is updated
